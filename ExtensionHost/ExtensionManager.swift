...
final class WhatsAppWebBridge: ObservableObject {
    ...
    private static let managedExtensionID = "halo.whatsapp-web"
    ...
    private func startProviderIfNeeded() {
        ...
        guard let nodeExecutableURL = resolveNodeExecutableURL() else {
            performBridgeUpdate {
                ...
                lastError = "Node.js is not installed. Please install it from nodejs.org, then restart Halo."
            }
    ...
    private static func showNodeJSInstallAlert() {
        ...
        alert.informativeText = "The WhatsApp integration needs Node.js to run. It's a free, one-time install — just download the macOS installer from nodejs.org and restart Halo."
