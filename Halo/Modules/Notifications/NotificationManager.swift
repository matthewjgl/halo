...
final class NotificationManager: ObservableObject {
    ...
    private static let whatsappExtensionID = "halo.whatsapp-web"
    ...
    private let logMonitorQueue = DispatchQueue(label: "halo.whatsapp-log-monitor", qos: .utility)
    private let deliveredMonitorQueue = DispatchQueue(label: "halo.notifications-delivered-monitor", qos: .utility)
