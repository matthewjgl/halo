...
struct AdvancedSettingsView: View {
            ...
            SettingGroup {
                HStack {
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        Text("Pick a specific display or let Halo choose")
            ...
            SettingGroup {
                HStack {
                    ...
                    .alert("Reset Settings", isPresented: $showResetAlert) {
                        ...
                        Text("This will reset all Halo settings to their defaults.")
                    }
                }
    ...
    private func resetAllSettings() {
        let domain = Bundle.main.bundleIdentifier ?? "com.vedit.halo"
