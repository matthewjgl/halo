...
final class AppDelegate: NSObject, NSApplicationDelegate {
    private static let linearExtensionID = "halo.linear-mentions"
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // defaults write com.vedit.halo "debug.alwaysShowOnboarding" -bool true
    ...
    private func handleOAuthCallback(url: URL) {
        guard let components = URLComponents(url: url, resolvingAgainstBaseURL: false),
              components.scheme?.lowercased() == "halo",
    ...
    private func installStatusItem() {
        ...
        if let button = item.button {
            button.image = NSImage(systemSymbolName: Constants.menuBarIconName, accessibilityDescription: "Halo")
        }
        ...
        menu.addItem(NSMenuItem.separator())
        menu.addItem(makeMenuItem(title: "Quit Halo", action: #selector(quitApp), keyEquivalent: "q"))
