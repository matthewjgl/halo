        ...
        VStack(spacing: 0) {
            ...
            if let appIcon = NSApp.applicationIconImage {
                Image(nsImage: appIcon)
                    ...
                    .shadow(color: Color.purple.opacity(0.4), radius: 20, y: 4)
                    .padding(.bottom, 16)
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Halo needs a few permissions to work properly.")
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Halo will run in the background.")
                    .font(.system(size: 14, weight: .regular))
                    .foregroundStyle(OBColors.textSecondary)
            }
            .padding(.bottom, 24)
