...
enum PermissionType: CaseIterable {
    ...
    var description: String {
        ...
        case .screenRecording: return "Lets Halo appear properly in screen recordings"
        case .calendar: return "Show upcoming events in the Halo"
        case .notifications: return "Mirror notifications in the Halo"
...
final class PermissionsManager {
    ...
    func openBluetoothSettings() {
        ...
        // which registers Halo in the Bluetooth privacy list.
