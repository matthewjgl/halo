...
Run the `Halo` scheme on your Mac. Accessibility permission is required for the island window to sit above other apps.

---

## What to work on

Check the [Issues](https://github.com/matthewjgl/halo/issues) tab. Issues labelled `good first issue` are a good starting point. For anything larger — new modules, architecture changes — open an issue first so we can align before you spend time on it.
